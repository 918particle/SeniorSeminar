...
\item Scientific writing at the professional level, with logical flow, and citations
...
\textbf{Special topics regarding career preparation.}  The following topics will be presented:
\begin{itemize}
\item Resume creation and preparation
\item Structure of an application for admission to a graduate program
\end{itemize}
\end{document}